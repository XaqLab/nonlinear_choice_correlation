%% This code generates Figure S7: Optimal decoding can be revealed with equal fidelity from either fine continuous estimation or fine binary discrimination.
