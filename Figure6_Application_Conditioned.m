...
% D_M1=Z_M1./sqrt(numel(ccSim1_F{1,1}));
% D2s_M1=Z2s_M1./sqrt(numel(ccSim2_square_F{1,1}));
% D2c_M1=Z2c_M1./sqrt(numel(ccSim2_cross_F{1,1}));
% 
% D_M2=Z_M2./sqrt(numel(ccSim1_F{1,2}));
% D2s_M2=Z2s_M2./sqrt(numel(ccSim2_square_F{1,2}));
% D2c_M2=Z2c_M2./sqrt(numel(ccSim2_cross_F{1,2}));

% [h1_M1,p1_M1] = signrank(ccSim1BS1{1,1},ccSim1_F{1,1},'Alpha',0.01)
% [h2s_M1,p2s_M1] = signrank(ccSim2_squareBS1{1,1},ccSim2_square_F{1,1},'Alpha',0.01)
% [h2c_M1,p2c_M1] = signrank(ccSim2_crossBS1{1,1},ccSim2_cross_M1(RandIndexM1),'Alpha',0.01)
% [h1_M2,p1_M2] = signrank(ccSim1BS1{1,2},ccSim1_F{1,2},'Alpha',0.01)
% [h2s_M2,p2s_M2] = signrank(ccSim2_squareBS1{1,2},ccSim2_square_F{1,2},'Alpha',0.01)
% [h2c_M2,p2c_M2] = signrank(ccSim2_crossBS1{1,2},ccSim2_cross_M2(RandIndexM2),'Alpha',0.01)
...
% save('CC_test_Conditioned_Data.mat');
