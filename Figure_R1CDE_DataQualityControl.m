%% This code generates Figure R1.C/D/E in the rebuttal letter: Data quality for the two monkeys used in our study.
%% When we resampled from both datasets to control for the number of trials and tuned neurons, and then used comparable datasets to do nonlinear choice correlation analysis
%% Data: monkey1_filter.mat, monkey2_filter.mat were generated from Code: FigureS5_Application.ipynb
